...
aoi_country = geodata::gadm(
  country="CAN", level=0, 
  path="./assets/SHP/aoi_country.shp") |> 
  sf::st_as_sf()

aoi_states  = geodata::gadm(
  country="CAN", level=1, 
  path="./assets/SHP/aoi_states.shp") |> 
  sf::st_as_sf()

sf::st_write(aoi_country, "./assets/SHP/aoi_country.shp", delete_dsn = T)
sf::st_write(aoi_states, "./assets/SHP/aoi_states.shp", delete_dsn = T)
crs_master = sf::st_crs(aoi_country) 

# --------------------------------------------------------- #
# Not best practice, but for declaring and transforming crs #
# crs_master <- sf::st_crs("epsg:4326")
# --------------------------------------------------------- #

aoi_site   = sf::read_sf(
  "./assets/SHP/chilwa_watershed_4326.shp") |>
...
# Robust & Accurate API: https://doi-usgs.github.io/nhdplusTools/reference/download_wbd.html
# Function Syntax: https://rdrr.io/cran/nhdplusTools/man/download_wbd.html

aoi_country <- giscoR::gisco_get_countries(
  country = "Canada", resolution = "3") |>
  sf::st_cast() |> sf::st_transform(crs_master)

tmap::tm_shape(aoi_states) + tm_borders(col = "red")
