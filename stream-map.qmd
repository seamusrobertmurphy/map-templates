...
lakes = sf::st_read("./assets/SHP/basins.shp") |> st_cast("POLYGON")
basins= sf::st_read("./assets/SHP/basins.shp") |> st_cast("MULTIPOLYGON")
rivers= sf::st_read("./assets/SHP/streams.shp")|> st_cast("MULTILINESTRING")
dem   = terra::rast("./assets/TIF/dem_3arc_condt.tif")
