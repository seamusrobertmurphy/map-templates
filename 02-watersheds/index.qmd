...
tmap::tmap_mode("view")
tmap::tm_shape(dem_breach_diff_fd) + tmap::tm_raster(values="RdYlBu", title = "Change (m)",
...
tmap::tm_shape(dem_breach_diff_wb) + tmap::tm_raster(values="RdYlBu", title = "Change (m)",
    breaks = c(-400, -100, -10, 0, 10, 100, 400),
    labels = c("-400 to -100", "-100 to -10", "-10 to 0", "0 to 10", "10 to 100", ">100")) +
  tmap::tm_scalebar(position=c("RIGHT", "BOTTOM"), text.size = .5) +
  tmap::tm_compass(color.dark="gray60",text.color="gray60",position=c("RIGHT", "top")) +
...
tmap::tm_shape(dem_fill_diff_fd) + tmap::tm_raster(values="RdYlBu", title = "Change (m)",
  ...
  tmap::tm_compass(color.dark="gray60",text.color="gray60",position=c("RIGHT", "top")) +
  tmap::tm_graticules(lines=T,labels.rot=c(0,90),lwd=0.2) +
  tmap::tm_title("Breaching Effects (Barnes, 2016)", size=.8) -> tm_fill_fd
...
tmap::tm_shape(dem_fill_diff_wb) + tmap::tm_raster(values="RdYlBu", title = "Change (m)",
  ...
  tmap::tm_compass(color.dark="gray60",text.color="gray60",position=c("RIGHT", "top")) +
  tmap::tm_graticules(lines=T,labels.rot=c(0,90),lwd=0.2) +
  tmap::tm_title("Breaching Effects (Lindsay, 2016a)", size=.8) -> tm_fill_wb
...
![Figure 2d: Map illustrating watershed delineation derived
in
flowdem](https://raw.githubusercontent.com/seamusrobertmurphy/map-templates/refs/heads/main/assets/MAP/watershed-flowdem.png)
...
fill_effect   = dem_filled - dem_100m
...
![Figure 2e: Map illustrating effects of breaching on
elevation models](/assets/MAP/breach-effects-wb.png)

### 2.4.2 Flow Accumulation
